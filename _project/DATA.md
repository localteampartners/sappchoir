...
```
pbpaste | sappvault set sappchoir DATABASE_URL --from-file -
pbpaste | sappvault set sappchoir SUPABASE_SERVICE_ROLE_KEY --from-file -   # Supabase only
```
