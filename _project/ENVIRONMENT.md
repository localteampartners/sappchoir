...
`sappvault://sappchoir/NAME` (macOS Keychain). Otherwise it's a
...
|---|---|---|---|
| `<!-- FILL IN -->` | <!-- FILL IN --> | <!-- e.g., "1Password > sappchoir > DB_URL" --> | <!-- e.g., "api, worker" --> |
|  |  |  |  |
...
- **Production:** <!-- FILL IN: e.g., "systemd EnvironmentFile=/etc/sappchoir.env", "Fly.io secrets", "Vercel dashboard" -->
