                              ...
                              int articulationIndex)
{
    ...
    // SappLink CC-in: mapped controllers steer ChoirParams during the render,
    // exactly as they steer the plugin's parameters live. The CC event is
    // still forwarded to the sampler (vowel crossfades, SFZ locc/hicc
    // conditions, engine-native CC1/CC11/CC64 behavior).
    ChoirParams liveParams = options.params;
